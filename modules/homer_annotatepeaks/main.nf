...
process ANNOTATE {
    ...
    stub:
    """
    echo -e "PeakID\tChr\tStart\tEnd\tStrand\tAnnotation\tGene Name\tGene Alias\tGene Description" > annotated_peaks.txt
    echo -e "Peak_1\tchr1\t1000\t2000\t+\tPromoter\tGene1\tAlias1\tDescription1" >> annotated_peaks.txt
